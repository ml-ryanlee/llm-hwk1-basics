...
def main():
    """Main function to encode OpenWebText datasets"""
    
    # Paths
    base_dir = Path(__file__).parent.parent
    data_dir = base_dir / "data"
    results_dir = base_dir / "results" / "owt-valid-results"
    
    train_data_path = str(data_dir / "owt_train.txt")
    valid_data_path = str(data_dir / "owt_valid.txt")
    vocab_path = str(results_dir / "vocab.pkl")
    merges_path = str(results_dir / "merges.pkl")
    
    # Output paths
    train_output = str(data_dir / "owt_train_tokens.npy")
    valid_output = str(data_dir / "owt_valid_tokens.npy")
