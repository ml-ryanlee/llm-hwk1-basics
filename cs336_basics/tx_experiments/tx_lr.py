...
os.environ["WANDB_API_KEY"] = "b75bf2d09dc306a9585ca2daeadd8bf1dbf7ee84"
...
def main():
    ...
    base_config = {
        ...
        'val_path': '/Users/ryanlee/code/llm-hwk1-basics/data/tinystories_valid_tokens.npy',
    ...
    learning_rates = [1e-4, 2e-4, 5e-4, 1e-3, 2e-3, 5e-3, 1e-2]
